...
// Login Page
router.get('/loginPage', forwardAuthenticated, (req, res) => res.sendFile(path.join(__dirname, '/views', 'loginPage.html')));
          ...
          bcrypt.hash(newUser.password, salt, (err, hash) => {
            ...
            newUser
              ...
              .then(user => {
                ...
                res.sendFile(path.join(__dirname, '/users', 'loginPage')
              })
